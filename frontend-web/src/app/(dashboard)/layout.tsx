...
const navigation = [
  ...
  { name: 'Flyttejournal', href: '/movements', icon: Truck },
  { name: 'Helse og kontroll', href: '/compliance', icon: ShieldCheck },
  { name: 'Foring', href: '/feedings', icon: Droplets },
  { name: 'Produksjon', href: '/production', icon: Package },
  { name: 'Produksjonspartier', href: '/production-batches', icon: PackageCheck },
